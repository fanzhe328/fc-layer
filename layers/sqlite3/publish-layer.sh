...
layer_name="sqlite3"
compatible_runtime="custom,custom.debian10,nodejs16,nodejs14,python3.10,python3.9,java8,java11"
zip_code="./layer.zip"
...
regions=${REGIONS-"cn-shenzhen cn-hangzhou cn-shanghai cn-qingdao cn-beijing cn-zhangjiakou cn-huhehaote cn-chengdu cn-hongkong ap-northeast-1 ap-southeast-1 eu-central-1 eu-west-1 us-west-1 us-east-1 ap-south-1 ap-southeast-3 ap-southeast-5 ap-southeast-2"}
